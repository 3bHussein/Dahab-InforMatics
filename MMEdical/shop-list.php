                        ...
                        <div class="widget_inner">
                            ...
                            <div class="widget_list widget_categories">
                                ...
                                <ul>
                                    ...
                                    <li>
                                        <a href="#">Braces & Supports</a>
                                    </li>
                                  
                                    <li>
                                        <a href="#">Graduated Compression</a>
                                    </li>
                                    <li>
                                        <a href="#">Bandages</a>
                                    </li>
                            ...
                            <div class="widget_list widget_categories">
                                ...
                                <ul>
                                    ...
                                    <li>
                                        <a href="#">50 EGY - 250 EGP</a>
                                    </li>
                                    <li>
                                        <a href="#">250 EGP - 500 EGP</a>
                                    </li>
                                    <li>
                                        <a href="#">500 EGP - 1000 EGP</a>
                                    </li>
                                    <li>
                                        <a href="#">1000 EGP - 2000 EGP</a>
                                    </li>
                                    <li>
                                        <a href="#">2000 EGP - 5000 EGP</a>
                                    </li>
                                    <li>
                                        <a href="#">5000 EGP - 20000 EGP </a>
                                    </li>
                                </ul>
                            </div>
                            <div class="widget_list widget_categories">
                        ...
                        <div class=" niceselect_option">
                            ...
                            <form class="select_option" action="#">
                                <select name="orderby" id="short">
                                    ...
                                    <option selected value="1">Sort by relevance</option>
                                    <option value="2">Sort by top rated</option>
                                    <option value="3">Sort by price: low to high</option>
                                    <option value="4">Sort by price: high to low</option>
                                    <option value="5">Product Name (Ascendig)</option>
                                    <option value="6">Product Name (Descendig)</option>
                        ...
                        <div class=" col-12 ">
                            <div class="single_product">
                                <div class="product_name grid_name">
                                    <h3><a href="#">Adjustable Ankle Stabilizer</a></h3>
                                    <p class="manufacture_product"><a href="#">Accessories</a></p>
                                </div>
                                <div class="product_thumb">
                                    <a class="primary_img" href="#"><img src="assets/img/trending/Adjustable-ankle-stabilizer.jpg" alt=""></a>
                                    <!-- <a class="secondary_img" href="#"><img src="assets/img/trending/Adjustable-ankle-stabilizer.jpg" alt=""></a> -->
                                    ...
                                    <div class="content_inner">
                                        ...
                                        <div class="product_footer d-flex align-items-center">
                                            ...
                                            <div class="add_to_cart">
                                                <a href="cart.php" title="add to cart" style="color: white;"><span class="lnr lnr-cart"></span></a>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                <div class="product_content list_content">
                                    <div class="left_caption">
                                        <div class="product_name" >
                                          <h3 style="font-size: 22px;">Adjustable Ankle Stabilizer</h3>
                                        </div>
                                        <div class="product_ratings">
                                            <ul>
                                                <li><a href="#"><i class="ion-star"></i></a></li>
                                        ...
                                        <div class="product_desc">
                                            <p>Adjustable Ankle Stabilizer is recommended to help support weak, sprained or arthritic ankles.</p>
                                        </div>
                                    </div>
                                    <div class="right_caption">
                                        ...
                                        <div class="price_box">
                                            <span class="current_price">350 EGP</span>
                                        </div>
                                        <div class="cart_links_btn">
                                            <a href="cart.php" title="add to cart" style="color: white;">add to cart</a>
                                        </div>
                                        <div class="action_links_btn">
                                            <ul>
                                                <li class="quick_button"><a href="#" data-bs-toggle="modal" data-bs-target="#modal_box" title="quick view"> <span class="lnr lnr-magnifier"></span></a></li>
                                                <li class="wishlist"><a href="wishlist.php" title="Add to Wishlist"><span class="lnr lnr-heart"></span></a></li>
                                            </ul>
                                        </div>
                                    </div>
                                </div>
