...
<head>
    ...
    <title>Autima - Coming soon</title>
    <meta name="description" content="">
    <meta name="viewport" content="width=device-width, initial-scale=1">
    <!-- Favicon -->
    <!-- <link rel="shortcut icon" type="image/x-icon"mg/favicon."> -->
        ...
        <div class="row">
            <div class="col-12">
                <div class="coming_soon_container">
                    ...
                    <!-- <a href="#"><h3 style="color: white;">MMedical</h3></a>

                </div> -->

                    <div class="coming_soon_title">
                        <p style="font-size: 60px; font-family: 'Raleway', sans-serif;">Coming Soon</p>
                    </div>

                    <!-- <div class="coming_soon_timing">
                    <a href="index.php" style="color: white; font-size:25px;">Back to home</a>
                    </div> -->
