	...
	<footer class="layout-dark">
		...
		<div class="copy-right">
			<div class="container padding-tb-50px">
				<div class="row">
					<div class="col-lg-6">
						<div class="copy-right-text text-lg-left text-center sm-mb-15px"> <a class="hovernew" href="http://dahab-informatics.com/"> © 2021 Dahab Informatics</a> - All rights reserved </div>
					</div>
					<div class="col-lg-6">
						<!--  Social -->
