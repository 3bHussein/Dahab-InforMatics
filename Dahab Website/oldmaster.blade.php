        ...
        <ul class="design-items form-row col">
            ...
            <li class="design-item">
                <div class="design-icon">
                    <img class="offer-image" src="images/ourtechnology/php.svg" alt="PHP technology" style="width: 59px;height: 62px;">
                </div>
                <h3 class="design-title">PHP</h3>
            </li>
            <li class="design-item">
                <div class="design-icon">
                    <img class="offer-image" src="images/ourtechnology/.netcore.svg"alt="C# technology" style="width: 59px;height: 62px;">
                </div>
            ...
            <li class="design-item">
                <div class="design-icon">
                    <img class="offer-image" src="images/ourtechnology/flutter.svg" alt="Flutter technology" style="width: 59px;height: 60px;">
                </div>
                <h3 class="design-title">Flutter</h3>
            </li>
            <li class="design-item">
                <div class="design-icon">
                    <img class="offer-image" src="images/ourtechnology/js.svg"alt="JS technology" style="width: 59px;height: 62px;" >
                </div>
            ...
            <li class="design-item">
                <div class="design-icon">
                    <img class="offer-image" src="images/ourtechnology/jquery.svg" alt="JQuery library"style="width: 59px;height: 62px;">
                </div>
