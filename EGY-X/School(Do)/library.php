...
?>
      ...
      <section class="breadcrumbs-custom-inset">
        <div class="breadcrumbs-custom context-dark bg-overlay-60">
          <div class="container">
            <h3 class="breadcrumbs-custom-title">Our Library</h3>
        ...
        <div class="container">
          <div class="row row-50 justify-content-center align-items-xl-center">
            ...
            <div class="col-md-10 col-lg-7 col-xl-6">
              <h3 class="text-spacing-25 font-weight-normal">Why Choose Us</h3>
              <!-- Bootstrap tabs-->
                ...
                <div class="tab-content">
                  ...
                  <div class="tab-pane fade" id="tabs-4-2">
                    <div class="row row-40 justify-content-center text-center inset-top-10">
                      ...
                      <div class="col-sm-4">
                        <!-- Circle Progress Bar-->
                        <div class="progress-bar-circle" data-value="0.99" data-gradient="#4261e4" data-empty-fill="transparent" data-size="150" data-thickness="12" data-reverse="true"><span></span></div>
